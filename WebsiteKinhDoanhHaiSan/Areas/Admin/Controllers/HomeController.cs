...
namespace WebsiteKinhDoanhHaiSan.Areas.Admin.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.TongSoLuongDonChoXuLy = ListHoaDonStatus("Chờ xử lý").Count();
            ViewBag.TongSoLuongDonDangGiaoHang = ListHoaDonStatus("Đang giao hàng").Count();
         ...
         public List<double> GetListDoanhThu4Tuan()
        {
            ...
            List<ChiTietHoaDon> orderDetails = db.ChiTietHoaDons
                .Where(m => m.HoaDon.NgayXuatHD >= firstDate
                            ...
                            && m.HoaDon.status.Equals("Giao hàng thành công"))
                .ToList();
        ...
        public double TongDoanhThuThang()
        {
            ...
            {
                if (o.status.Equals("Giao hàng thành công"))
                {
        ...
        public List<HoaDon> ListHoaDonStatus(string status)
        {
            
            return db.HoaDons.Where(m => m.status.Equals(status)).ToList();
        }
